...
import 'package:sleuth/screens/change_password/bloc/change_password_bloc.dart';
    ...
    return BlocProvider<ChangePasswordBloc>(
      ...
      child: BlocConsumer<ChangePasswordBloc, ChangePasswordState>(
        ...
        builder: (context, state) {
          if (state is ChangePasswordProgress) return Stack(children: [_editAccountContent(context), SleuthLoading()]);
