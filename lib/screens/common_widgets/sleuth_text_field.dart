...
class SleuthTextField extends StatefulWidget {
  final String title;
  ...
  @override
  _SleuthTextFieldState createState() => _SleuthTextFieldState();
}

class _SleuthTextFieldState extends State<SleuthTextField> {
  ...
  @override
  void didUpdateWidget(covariant SleuthTextField oldWidget) {
