...
import 'package:sleuth/screens/change_password/change_password_page.dart';
...
import 'package:sleuth/screens/common_widgets/settings_container.dart';
import 'package:sleuth/screens/common_widgets/settings_textfield.dart';
import 'package:sleuth/screens/edit_account/bloc/edit_account_bloc.dart';
      ...
      child: BlocConsumer<EditAccountBloc, EditAccountState>(
        ...
        builder: (context, state) {
          if (state is EditAccountProgress)
            return Stack(
              children: [_editAccountContent(context), SleuthLoading()],
            );
